Game.Canvas.Scene.New({
	...
	refresh: function(type) {
		...
		if (type == "save") {
			...
			back = function() {
				Game.Canvas.Scene.exit("Scene_Load");
			};
		}
		else {
		...
		Game.Canvas.Input.press([Input.Esc], back);
	},
	...
	refreshSlot: function(el, data) {
		...
		Game.Path.loadMaterial("characters" , data.actor_face, function() {
			var img = Game.Canvas.Materials.get("characters_" + data.actor_face);
